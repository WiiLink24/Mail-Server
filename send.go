...
var (
	...
	fromRegex        = regexp.MustCompile(`^MAIL FROM:\s(.*)@mail.wiilink24.com$`)
	fromRegexPayload = regexp.MustCompile(`^From:\s(.*)@mail.wiilink24.com$`)
)
